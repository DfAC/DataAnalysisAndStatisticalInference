...
We have multiple groups so to prove my theory the easiest approach is to use $\chi^2$ test of independence, verifying if our categorical variables (interest in politics and opinion about global warming) are independent of each other. With multiple groups we can't check hypothesis and confidence interval separately and we need to relay on the $\chi^2$ test of independence.
